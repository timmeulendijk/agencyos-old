...
import { _ as _sfc_main$2 } from './CollectionsDetail-fGIsVsks.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_HelpCollectionsDetail = _sfc_main$2;
  ...
  _push(ssrRenderComponent(_component_HelpCollectionsDetail, { "base-url": "/portal" }, null, _parent));
  _push(`</div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layers/portal/pages/portal/help/collections/[slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-Dwa4bHes.mjs.map
