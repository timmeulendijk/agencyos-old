...
import { _ as _sfc_main$3 } from './CollectionsDetail-fGIsVsks.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_HelpCollectionsDetail = _sfc_main$3;
  _push(ssrRenderComponent(_component_BlockContainer, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`</header>`);
        _push2(ssrRenderComponent(_component_HelpCollectionsDetail, { "base-url": "" }, null, _parent2, _scopeId));
      } else {
        return [
          ...
          createVNode(_component_HelpCollectionsDetail, { "base-url": "" })
        ];
      }
    }),
    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/help/collections/[slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-DFqPl3YX.mjs.map
