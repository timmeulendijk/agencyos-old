import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { AsyncLocalStorage } from 'node:async_hooks';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'vue-bundle-renderer/runtime';
import { u as useRuntimeConfig, h as eventHandler, s as setResponseHeader, i as send, j as getResponseStatus, k as setResponseStatus, l as useNitroApp, m as setResponseHeaders, n as joinRelativeURL, g as getQuery, c as createError, o as getRouteRules, q as hash, t as getResponseStatusText, r as readBody, v as destr } from '../runtime.mjs';
